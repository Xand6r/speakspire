...
import {
    SPEAKER_SPECIALITY, TOPIC_AREAS,
    DEFAULT_MULTI_OPTIONS, DEFAULT_SINGLE_OPTIONS,
    EDUCATION_OPTIONS, LANGUAGE_OPTIONS
} from './constants';
                            ...
                            state.certifications.map((cert, index) => (
                                <div className="expertise__formsection__section__form">
                                    ...
                                    <div className="--input_wrapper">
                                        ...
                                        <div
                                            className={`--two_inputs --half_date ${cert.link?'--link':''} ${cert.file?'--file':''}`}
                                        >

                                            <Upload {...props}
                                                beforeUpload =  {file => {
                                                    changeListData('certifications', index, 'file',  file)
                                                    return false;
                                                }}>
