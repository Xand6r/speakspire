...
import { COUNTRY_LIST } from '../../../../utilities/constants';
import PasswordStrengthBar from 'react-password-strength-bar';

import { SPEAKER_PERSONAL_DETAILS_KEY } from '../../component/constants';

import { cacheFormState } from '../../../../utilities/dataPersist';
...
export default function Personaldetails({ stateChanger, state }) {
	...
	return (
		<div className='personaldetails'>
			<div className='personaldetails__heading'>
				<div className='personaldetails__heading__header'>Personal Details</div>
			...
			<div className='personaldetails__formsection'>
				...
				<div className='--wrapper'>
					...
					<div className='--gendersection'>
						{GENDER_OPTIONS.map((gender, index) => (
							<GenderTab key={Math.random()} option={gender} index={index} active={index === activeTab} changeTab={makeActive} />
						))}
					</div>
				</div>
				{/* wrapper for the gender */}
				...
				<div className='--wrapper'>
					...
					<input type='text' id='city' name='city' placeholder='Enter your city or state' onChange={handleFormChange} value={state.city} />
				</div>
				{/* wrapper for the city or state */}
