...
export const MoreOrLess = ({ more }) => (
	<div className='moreorless'>
		...
		<img src={more ? downArrow : upArrow} alt='' />
	</div>
);
		...
		<div className={`profile_speakercall ${!more && '--showmore'}`}>
			...
			<div className='profile_speakercall__details'>
				<div className='profile_speakercall__details__detail'>
					...
					<div className='--premium'>{category}</div>
				</div>
				...
				<div className='profile_speakercall__details__detail'>
					...
					<div className='--value'>{getPrice(budget)}</div>
				</div>
			</div>

			<div className='profile_speakercall__bio'>{description}</div>

			<div className='profile_speakercall__action'>Send Request</div>
		</div>
	);
}
