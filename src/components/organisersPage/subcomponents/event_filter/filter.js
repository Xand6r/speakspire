    ...
    return (
        <div>
            <div className="filter --eventspage">
                ...
                Behind every memorable event is a great event organizer
                </div>

                <div className="filter__subheader">
                Events are only as good as the speakers at the event. 
                 Finding the right speakers for your event couldn’t be any easier. Simply upload your event, recieve requests from our speakers and choose your preferred speakers.
                </div>
