    ...
    return (
        <div className="favouritesfilter">
            ...
            <div className="favouritesfilter__tabswrapper">
                <div
                    className={`favouritesfilter__tabswrapper__tab ${(activeTab === 0) && "--active"}`}
                ...
                <div
                    className={`favouritesfilter__tabswrapper__tab ${(activeTab === 1) && "--active"}`}
                ...
                <div
                    className={`favouritesfilter__tabswrapper__tab ${(activeTab === 2) && "--active"}`}
