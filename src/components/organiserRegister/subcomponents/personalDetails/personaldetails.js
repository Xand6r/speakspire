...
import { ORGANISER_PERSONAL_DETAILS_KEY } from '../../component/constants';
	...
	return (
		<div className='companypersonaldetails'>
			<div className='companypersonaldetails__heading'>
				<div className='companypersonaldetails__heading__header'>Organizer Details</div>
			...
			<div className='companypersonaldetails__formsection'>
				...
				<div className='--wrapper'>
					...
					<input type='text' id='city' name='city' placeholder='Enter your city or state' onChange={handleFormChange} value={state.city} required />
				</div>
				{/* wrapper for the city or state */}
