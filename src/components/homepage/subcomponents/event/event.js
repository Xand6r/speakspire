		...
		<div>
			<div className='event'>
						...
						<div className='--card'>
							{upcomingEvents.map((event, i) => (
								<div className='--card-item' key={i}>
									...
									<div className='date'>{event[1]}</div>
								</div>
							))}
						</div>
					</div>
				...
				<div className='event__text'>
					<div className='--header'>Let’s find the right speakers for your events</div>
					<div className='--subheader'>Find your speaker in a different way in 3 simple steps:</div>
					...
					<div className='--button' onClick={() => history.push('/registerevent')}>
						Add Event
					</div>
				</div>
			</div>
